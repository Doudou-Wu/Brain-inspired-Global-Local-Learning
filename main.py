'''
This is the code for baseline comparision of the Fashion-MNIST dataset.
network architecture: 6-layer CNN with [input-128C3-AP2-256C3-AP2-256C3-AP2-512FC-10]
'''
...
def main():
    ...
    '''
    # python -m main -T 4 -device cuda:0 -b 128 -epochs 64 -data-dir /data -amp -cupy -opt sgd -lr 0.1 -j 8

    # python -m main -T 4 -device cuda:0 -b 4 -epochs 64 -data-dir /data -amp -cupy -opt sgd -lr 0.1 -j 8 -resume ./logs/T4_b256_sgd_lr0.1_c128_amp_cupy/checkpoint_latest.pth -save-es ./logs
